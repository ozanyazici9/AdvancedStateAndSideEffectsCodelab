...
fun CraneHome(
    ...
    // scaffold un durumuna drawer ı açık kapamak ve recomposition ı ona göre yapmak için ihitiyacımız var.
    ...
    Scaffold(
        ...
        CraneHomeContent(
            ...
            openDrawer = {
                scope.launch {
                    // .open fonksiyonu bir animasyon ile yandaki menüyü yani drawer ı açtığı için
                    // suspend bir fonksiyon bu yüzden coroutinescope içerisinde çağırıyoruz.
