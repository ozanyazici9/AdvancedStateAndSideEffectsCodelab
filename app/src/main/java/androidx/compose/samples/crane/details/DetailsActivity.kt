...
fun DetailsScreen(
    ...
    // TODO Codelab: produceState step - Show loading screen while fetching city
    /**
     * produceState, Jetpack Compose'da belirli bir UI durumu oluşturmak için kullanılan bir API'dir.
     * produceState, remember gibi çalışır ancak daha dinamik ve zaman içinde değişen veri kaynaklarıyla
     * (örneğin, bir ağ isteği veya veri tabanından alınan veriler) durum üretmenizi sağlar.
     */
